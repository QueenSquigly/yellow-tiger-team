# Guessing Game - taurean, kalen, vincent, hassan
...
def play_guessing_game():
    ...
    while True:
        ...
        if user_guess == secret_number: # checks if guess is the secret number
            ...
            break
        elif user_guess < secret_number: # checks if guess is lower than the secret number
            print(f"Number guessed: {user_guess}")
            print(f"current attempts: {attempts}")
            print("Too low\n")
        else: # checks if guess is higher than the secret number
            print(f"Number guessed: {user_guess}")
            print(f"current attempts: {attempts}")
            print("Too High\n")
